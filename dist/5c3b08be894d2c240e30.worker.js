...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__exceptions__ = __webpack_require__("./src/app/exceptions.ts");
...
class SchedulingWorker {
    ...
    groupClassSectionByBigSection(course) {
        ...
        for (const exceptionType in __WEBPACK_IMPORTED_MODULE_1__exceptions__["a" /* EXCEPTIONS */]) {
            if (deptName in __WEBPACK_IMPORTED_MODULE_1__exceptions__["a" /* EXCEPTIONS */][exceptionType]) {
     ...
     * @param section
     */
    createBigSectionGenerator(bigSectionAlreadyTyped) {
        const gen = function* () {
...
self.onmessage = (e) => {
    ...
    // workaround
    console.log(stateMachine.next().value);
    console.log("POSTING MESSAGE");
    postMessage.apply(null, []);
};
...
/******/ });
//# sourceMappingURL=5c3b08be894d2c240e30.worker.js.map